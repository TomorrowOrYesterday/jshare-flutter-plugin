...
class JShare {
  ...
  static final _instance = new JShare.private(const MethodChannel("jshare_flutter_plugin"));
  ...
  Future<JShareSocial> authorize({@required JSharePlatform platform}) async {
    ...
    Map resultMap = await _channel.invokeMapMethod("authorize",map);
  ...
  Future<JShareResponse> isPlatformAuth({@required JSharePlatform platform}) async {
    ...
    Map map = Map();
    map["platform"] = getStringFromEnum(platform);
    Map resultMap = await _channel.invokeMapMethod("isPlatformAuth",map);
    JShareResponse response = JShareResponse.fromJson(resultMap);
  ...
  Future<JShareResponse> cancelPlatformAuth({@required JSharePlatform platform}) async {
    ...
    Map map = Map();
    map["platform"] = getStringFromEnum(platform);
    Map resultMap = await _channel.invokeMapMethod("cancelPlatformAuth",map);
    JShareResponse response = JShareResponse.fromJson(resultMap);
  ...
  Future<bool> isClientValid({@required JSharePlatform platform}) async {
    ...
    Map map = Map();
    map["platform"] = getStringFromEnum(platform);
    Map resultMap = await _channel.invokeMapMethod("isClientValid",map);
    JShareResponse response = JShareResponse.fromJson(resultMap);
...
class JShareSocial extends JShareResponse {
  ...
  JShareSocial.fromJson(Map<dynamic, dynamic>jsonMap)
      : openid = jsonMap["openid"],
        ...
        originData = jsonMap["originData"]!=null?json.decode(jsonMap["originData"]):null,
...
class JShareMessage {
  ...
  Map toJsonMap() {
    return {
      ...
      "miniProgramPath": miniProgramPath ??= null,
      "miniProgramType": miniProgramType ??= null,
      "miniProgramWithShareTicket": miniProgramWithShareTicket ??= null,
